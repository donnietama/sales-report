    ...
    <div class="px-4 py-4">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <h3 class="text-capitalize">export data product solds</h3>
                <hr>
...
export default {
    ...
    methods: {
        getAPI(page = 1) {
            axios.get('/api/reports/productsold?page=' + page).then(res => {
                this.api = res.data
            })
            Event.$on('added_productsold', (apiData) => {
        ...
        getRequested() {
            axios.post('/search/productsolds', {
